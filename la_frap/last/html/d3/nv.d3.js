...
function finance(){
    ...
    var histcatexplong = [
        {
            "key" : "Région" ,
            "values" : [ [ 2006 , 910] , [ 2007 , 2748] , [ 2008 , 4825], [ 2009 , 4452] , [ 2010 , 3741] , [ 2011 , 3920], [ 2012 , 4690] , [ 2013 , 5171] , [ 2014 , 5793] ],
        } ,
        {
            "key" : "Département" ,
            "values" : [ [ 2006 , 2100] , [ 2007 , 2528] , [ 2008 , 2926], [ 2009 , 2573] , [ 2010 , 2468] , [ 2011 , 2677], [ 2012 , 3009] , [ 2013 , 3193] , [ 2014 , 3003] ]
        } ,
        {
            "key" : "Communes + Communauté de communes" ,
            "values" : [ [ 2006 , 16165] , [ 2007 , 15730] , [ 2008 , 15663], [ 2009 , 14672] , [ 2010 , 18516] , [ 2011 , 16268], [ 2012 , 15263] , [ 2013 , 22468] , [ 2014 , 22380] ]
        } ,
        {
            "key" : "FSER" ,
            "values" : [ [ 2006 , 41752] , [ 2007 , 43292] , [ 2008 , 40496], [ 2009 , 44645] , [ 2010 , 49528] , [ 2011 , 52506], [ 2012 , 53676] , [ 2013 , 47433] , [ 2014 , 48530] ]
        } ,
        {
            "key" : "Aides à l'emploi" ,
            "values" : [ [ 2006 , 11431] , [ 2007 , 10508] , [ 2008 , 10029], [ 2009 , 10057] , [ 2010 , 12913] , [ 2011 , 12104], [ 2012 , 11271] , [ 2013 , 9952] , [ 2014 , 9653] ]
        } ,
...
//
        ...
        d3.select('#financement')
            .datum(histcatexplong)
            .transition().duration(1000)
            .call(chart)
            .each('start', function() {
                setTimeout(function() {
                    d3.selectAll('#financement *').each(function() {
...
function rh()
{
    var histcatexplong = [
        {
            "key" : "Nombre total de salariés" ,
            "values" : [ [ 2006 , 3] , [ 2007 , 3.7] , [ 2008 , 3.8], [ 2009 , 3.7], [ 2010 , 3.7], [ 2011 , 3.9], [ 2012 , 3.8], [ 2013 , 3.7], [ 2014 , 4.5] ]
        } ,
        {
            "key" : "Equivalent Temps Plein" ,
            "values" : [ [ 2006 , 2.4] , [ 2007 , 2.8] , [ 2008 , 3.0], [ 2009 , 3.0], [ 2010 , 2.8], [ 2011 , 2.8], [ 2012 , 2.7], [ 2013 , 3.2], [ 2014 , 4.1] ]
        } ,
        {
            "key" : "Total bénévoles" ,
            "values" : [ [ 2006 , 57] , [ 2007 , 52] , [ 2008 , 58], [ 2009 , 65], [ 2010 , 69], [ 2011 , 70], [ 2012 , 72], [ 2013 , 66], [ 2014 , 64] ]
        } 
...
//
        ...
        d3.select('#financement')
            ...
            .each('start', function() {
                setTimeout(function() {
                    d3.selectAll('#financment *').each(function() {
                        if(this.__transition__)
                            this.__transition__.duration = 1;
                    })
                }, 0)
...
nv.models.tooltip = function() {
    ...
    Example Format of data:
    {
        ...
        value: "August 2009",
        series: [
            {key: "Series 1", value: "Value 1", color: "#fff"},
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            interactiveLayer.dispatch.on('elementMousemove', function(e) {
                ...
                if (showTotalInTooltip && stacked.style() != 'expand' && allData.length >= 6) {
                    allData.push({
                        key: totalLabel,
                        value: valueSum,
                        total: true
