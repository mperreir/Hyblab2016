...
var ugo_description = ["La société Huso, par le biais de la plateforme Wiseed a réussi à lever 948 000 € (4M300 € au total) en seulement 20 jours, un véritable succès pour cette jeune entreprise. Huso produit en Périgord son propre caviar, dénommé Caviar de Neuvic, un produit français de très grande qualité. Cette levée de fonds a permis à l’entreprise Périgourdine de renforcer sa présence en France mais également de se lancer à l’international.", 
				   "Kalelithos Invest, grâce à la plateforme de financement alternatif Anaxago a réussi à lever plus de 1.8 M d’euros. Cet appel au financement, sous cette forme, est une première en France pour un promoteur immobilier. Cette levée a permis à la société de financer et lancer trois projets sur une durée de trois ans, en Languedoc-Roussillon ainsi qu’à Toulouse.",
				   "L’entreprise Canibal a réussi à lever 500000€ de fonds grâce à la plateforme SmartAngels. Concept unique au monde et 100% français, Canibal est le seul collecteur à traiter simultanément les 3 types de déchets : bouteilles, canettes et gobelets. La machine se veut ludique et incite au recyclage par le jeu. Au-delà de la prise de conscience écologique, les usagers se voient remettre des coupons de réduction pour les magasins alentours ou des micros-dons pour des associations. Un concept qui rime avec écologie et économie.", 
				   "L’entreprise Novolyze demandait 650 000 euros. La start-up a finalement obtenu au-delà de ses espérances puisqu’elle a récolté 900 000 euros auprès de la communauté d’investisseurs de la plateforme de crowdfunding Anaxago. Novolyze travaille sur la prévention sanitaire grâce à des germes modèles qualifiés et brevetés, elle aide les entreprises agroalimentaires à maîtriser leurs risques microbiologiques et sanitaires. Cette levée de fonds permet à l’entreprise de soutenir sa croissance et de se développer davantage à l’internationale, et principalement aux Etats-Unis.",
				   "Flashgap a levé 600000€ sur la plateforme dédiée aux jeunes PME en recherche de financement, Anaxago. Cette application se veut être à mi-chemin entre Snapchat et les flux de photos d’iCloud. Le principe est assez simple, l’application permet de créer un album photo et d’y inviter les personnes présentes avec vous, ainsi chaque participant prend des clichés via l’application, qui sont alors directement stockés dans l’album crée dans Flashgap. Cependant ce qui fait l’originalité de ce réseau social est que les clichés réalisés disparaissent instantanément après avoir été pris et que ceux-ci ne sont dévoilés que le lendemain seulement, à midi pile très exactement. Une application qui vous permettra de retrouver la mémoire pour le meilleur… ou pour le pire.",
				   "Après une levée de fonds réussie de 1,2M€ sur SmartAngels en décembre 2015, la jeune société française Ween, fondée en 2014 et basée à Aix-en-Provence a pu réaliser son objectif de commercialisation en Europe de son thermostat connecté. Ce thermostat connecté à une box a la particularité de réagir en temps réel à différents événements, et notamment à la présence/absence des occupants d’une maison grâce à l’analyse de la position GPS de leur Smartphone (via une technologie dite Smart Time brevetée).",
				   "Poietis, leader Français de la Bioimpression a poursuivi sa croissance en bouclant un premier tour de financement de 2,5M€ incluant une collecte de fonds record de 1,2M€ en Octobre 2015 sur la plateforme de financement participatif Wiseed. Les fonds levés ont pour but l’industrialisation de la technologie de la Bioimpression par Laser et l’arrivée sur le marché des premiers tissus bioimprimés.",
				   ...
				   "La société CEM, propriétaire de 15 centrales hydroélectriques et spécialiste en électricité industrielle, a bouclé début décembre 2015 une campagne d’un million d’euros sur la plateforme de crowdfunding consacré aux projets locaux, Bulb in Town. L’objectif de cette campagne étant la construction d’une centrale hydroélectrique en Ariège.",
...
function display(ugo_id) {
	...
	d3.select("#fonds").text(function() {return "Fonds totaux levés pour ce projet : " + ugo_fonds[ugo_id] + "€"});
