!function (n, t) {
    ...
    function c(n, t) {
        ...
        var s = r(n.transform), l = n.arcs, h = {
            Point: function (n) {
    ...
    function v(n, t) {
        ...
        function e(t) {
            return p(c(n, {type: "Polygon", arcs: [t]}).coordinates[0]) > 0
        }
        ...
        return t.forEach(function (n) {
            ...
            type: "MultiPolygon", arcs: u.map(function (t) {
                ...
                if (t.forEach(function (n) {
                    ...
                    }), i = a(n, i), (r = i.length) > 1)for (var u, f = e(t[0][0]), c = 0; r > c; ++c)if (f === e(i[c])) {
                    u = i[0], i[0] = i[c], i[c] = u;
                    break
                }
                return i
    ...
    function E(n, t) {
        ...
        var i = r(n.transform), u = e(n.transform), f = m();
