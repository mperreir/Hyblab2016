!function () {
    ...
    function Ht(n, t, e, r) {
        var u;
        if (null == n)u = e * Ha, r.point(-Ua, u), r.point(0, u), r.point(Ua, u), r.point(Ua, 0), r.point(Ua, -u), r.point(0, -u), r.point(-Ua, -u), r.point(-Ua, 0), r.point(-Ua, u); else if (Ma(n[0] - t[0]) > Da) {
            var i = n[0] < t[0] ? Ua : -Ua;
    ...
    function Ot(n, t) {
        ...
        for (var o = 0, l = t.length; l > o; ++o) {
            ...
            if (s)for (var f = c[0], h = f[0], g = f[1] / 2 + Ua / 4, p = Math.sin(g), v = Math.cos(g), d = 1; ;) {
                d === s && (d = 0), n = c[d];
                var m = n[0], y = n[1] / 2 + Ua / 4, M = Math.sin(y), x = Math.cos(y), b = m - h, _ = b >= 0 ? 1 : -1, w = _ * b, S = w > Ua, k = p * M;
    ...
    function It(n) {
        ...
        function r(n, t, e) {
            ...
            if (!(0 > M)) {
                ...
                w > S && (_ = w, w = S, S = _);
                var E = S - w, A = Ma(E - Ua) < Da, C = A || Da > E;
    ...
    function Lr(n, t) {
        var e;
        return arguments.length < 2 && (t = .45), arguments.length ? e = t / ja * Math.asin(1 / n) : (n = 1, e = t / 4), function (r) {
    ...
    var oa = {version: "3.5.14"}, la = [].slice, ca = function (n) {
        return la.call(n)
    }, sa = this.document;
    if (sa)try {
    ...
    var Da = 1e-6, Pa = Da * Da, Ua = Math.PI, ja = 2 * Ua, Fa = ja - Da, Ha = Ua / 2, Oa = Ua / 180, Ia = 180 / Ua, Ya = Math.SQRT2, Za = 2, Va = 4;
    ...
    oa.layout.hierarchy = function () {
        ...
        var t = Number, e = xl, r = 0, u = ja, i = 0;
    ...
    var Ul = Math.sqrt(3), jl = Math.tan(30 * Oa);
